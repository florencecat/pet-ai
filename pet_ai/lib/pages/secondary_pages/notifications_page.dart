...
class _NotificationPageState extends State<NotificationsPage> {
  ...
  Future<void> _pickQuietTime(bool isStart) async {
    final current = isStart
        ? _notificationSettings.quietStartMinutes
        : _notificationSettings.quietEndMinutes;
                    ...
                    SettingsRow(
                      ...
                      trailing: OutlinedSwitch(
                        ...
                        onChanged: (v) => _updateNotif(
                          _notificationSettings.copyWith(enabled: v),
                        ),
                      ),
                    ...
                    if (_notificationSettings.enabled) ...[
                      ...
                      if (_notificationSettings.quietHoursEnabled) ...[
                        ...
                        SettingsRow(
                          ...
                          label: 'Начало',
                          subtitle: _fmtMinutes(
                            _notificationSettings.quietStartMinutes,
                          ),
                          iconColor: ac.primaryColor,
                          trailing: settingsChevronIcon(
                            ac.primaryColor.withAlpha(140),
                          ),
                      ...
                      SettingsRow(
                        ...
                        iconColor: ac.primaryColor,
                        trailing: OutlinedSwitch(
                          value: _notificationSettings.sound,
                          onChanged: (v) => _updateNotif(
                      ...
                      SettingsRow(
                        ...
                        iconColor: ac.primaryColor,
                        trailing: OutlinedSwitch(
                          value: _notificationSettings.highImportance,
                          onChanged: (v) {
                            _updateNotif(
